...
anfis = ANFIS(num_inputs=2, num_mfs=3)
...
# ========== FEATURE EXTRACTION (12 aligned features) ==========
            ...
            if anfis_output > threshold:
                ...
                try:
                    ...
                    if counter.count % 5 == 0:
                        print("📧 5 new attacks blocked. Sending email...")
...
import torch.nn as nn
#import numpy as np
# from scapy.all import send, IP, TCP  # Removed since no longer simulating
