...
def fit_label_encoders():
    ...
    conn_state_encoder.fit(['S0', 'SF', 'REJ', 'RSTO', 'OTH', '-'])  # ← Added 'OTH'
    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            if anfis_output > threshold:
                ...
                # Optional: store benign flow
                # AttackLog.objects.create(source_ip=src_ip, score=anfis_output, status="Benign")
